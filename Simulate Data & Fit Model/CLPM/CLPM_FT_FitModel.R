...
RES <- foreach (IT = 1:numits,.combine='rbind', .errorhandling = "pass") %dopar% {
    ...
    output.directory<-paste0("/gpfs/alpine1/scratch/toch9438/GE75/GE.Output/CLPM_FT/CLPM_FT_j", j, "_IT", IT, ".csv")
...
write.csv(RES,paste0("/gpfs/alpine1/scratch/toch9438/GE75/GE.Output/Power/CLPM/FT_Estimates_",j))
}